...
<head>
	...
	<link rel="stylesheet" href="../CSS/currentCourseTable.css">
<style type="text/css">
...
$query = "SELECT COURSE_NAME, SEC, DAY, TIME FROM CourseRegistration WHERE COURSE_NAME IN ('Bangladesh Studies', 'IP', 'Datascience')";
$stid = oci_parse($conn, $query);
oci_execute($stid);

echo '<table>';
echo '<tr><th>COURSE_NAME</th><th>SEC</th><th>DAY</th><th>TIME</th></tr>';
